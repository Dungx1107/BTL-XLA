...
from filters.constant_time_bilateral_7 import SplVer
...
def main():
    ...
    ct_paper_v1 = ConstantTimeBilateral(n_samples=9, sigma_s=S_S, sigma_r=S_R)
    ct_paper_v2 = CTB_Version2(n_samples=20, sigma_s=S_S, sigma_r=S_R)
    # ct_variance_split = BoxSplitVer(40, sigma_s=S_S, sigma_r=S_R)
    # ct_variance_split = SplVer(0.1, sigma_s=S_S, sigma_r=S_R)
    ...
    # tester.register_filter('Original filter(n_samples=9)', lambda img: ct_paper_v1.apply(img))
